        ...
        if($location===false) {
            ...
            print "<div class='col-xs-12 col-sm-12 col-md-6 col-lg-5'>";
                ...
                if ($User->get_module_permissions ("locations")>=User::ACCESS_RW) {
					...
					$links[] = ["type"=>"link", "text"=>_("Upload file"), "href"=>"", "class"=>"open_popup", "dataparams"=>"data-script='app/admin/files/edit.php' data-action='upload'  data-id='$location->id'", "icon"=>"upload"];
