...
function submit_popup_data(result_div, target_script, form_element, reload) {
    // show spinner
    showSpinner();
    // set reload
    reload = typeof reload !== 'undefined' ? reload : true;
...
$(document).on("click", "#editLocationSubmit", function() {
    var form_element = $('form#editLocation')[0]; // obter o elemento do formulário
    submit_popup_data(".editLocationResult", "app/admin/locations/edit-result.php", form_element);
    return false;
});
